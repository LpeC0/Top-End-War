...
public class GameOverUI : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        mainMenuButton?.onMainMenuClicked();
    }
...
public class PlayerStats : MonoBehaviour
{
            ...
            case GateStatType2.AddSoldierCount:
            {
                ...
                switch (mod.targetType)
                {
                    case GateTargetType2.PiyadeSoldiers:
                        ArmyManager.Instance?.AddSoldier(SoldierPath.Piyade, count);
                        break;
                    case GateTargetType2.MekanikSoldiers:
                        ArmyManager.Instance?.AddSoldier(SoldierPath.Mekanik, count);
                        break;
                    case GateTargetType2.TeknolojiSoldiers:
                        ArmyManager.Instance?.AddSoldier(SoldierPath.Teknoloji, count);
                        break;
    ...
    {
        // Eski GateData yapisi eger eski prefab kalirsa diye guvence.
        // Icerigi kaldirilabilir, ama projede referans varsa diye burada birakildi.
    }
    ...
    public string GetTierName()
    {
        ...
        return fallback[Mathf.Clamp(CurrentTier - 1, 0, 4)] + " (Fallback)";
    }
...
public class SoldierUnit : MonoBehaviour
{
    ...
    void TryShoot()
    {
        ...
        { 1 => 0f, 2 => 0.10f, 3 => 0.20f, 4 => 0.30f, 5 => 0.40f };
